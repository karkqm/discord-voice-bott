...
class Config:
    ...
    SYSTEM_PROMPT: str = (
        ...
        "- У тебя есть доступ в интернет. Если в контексте есть [Результаты поиска], ОБЯЗАТЕЛЬНО используй их для ответа. Не говори что не знаешь, если результаты поиска есть."
    )
